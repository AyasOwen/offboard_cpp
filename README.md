...
首次起飞示例 和 动物检测系统，具体请前往 [src/examples/README.md](https://github.com/AyasOwen/offboard_cpp/src/examples/README.md)

## Hardware

其中**蜂群**所使用的无人机硬件清单在 [hardware/hardware.pdf](https://github.com/AyasOwen/offboard_cpp/hardware/hardware.pdf)
